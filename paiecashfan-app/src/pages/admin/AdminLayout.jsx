...
import {
  ...
  Trophy, LogOut, ChevronRight, Settings, ArrowLeft, Globe, FileCheck, Receipt, Gift, Grid3x3, ShieldAlert, PackageCheck, Sparkles, Ticket
} from 'lucide-react';
...
const sideNav = [
  ...
  { to: '/admin/redtaag',    label: 'Billetterie',     icon: Ticket },
  ...
  { to: '/admin/bingo',      label: 'Sport Bingo',     icon: Grid3x3 },
